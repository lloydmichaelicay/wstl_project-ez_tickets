...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="left">
                <img src="images/eastwood_seating.png" alt="Arena Seat Plan">
            </div>
   
        <div class="right">
            <h2>Jepoy & The Magic Circle</h2>
            <h3>October - December 2024 | EASTWOOD THEATER</h3>
            <br>
            <div class="form-group"> 
                ...
                <select id="location" onchange="filterSections()" required>
                    ...
                    <option value="jepoy-orch-left" data-price="2500">Orchestra Left</option>
                    <option value="jepoy-orch-center" data-price="3000">Orchestra Center</option>
                    <option value="jepoy-orch-right" data-price="2500">Orchestra Right</option>
                </select>
            </div>
            <div class="form-group">
