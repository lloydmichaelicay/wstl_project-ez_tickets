...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="left">
                <img src="images/esports.jpg" alt="Arena Seat Plan">
            </div>
 
        <div class="right">
            <h2>COT Week League of Legends Finals</h2>
            <h3>June 22, 2025 | LPU ESports Arena</h3>
            <br>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select id="location" name="seat_section" onchange="filterSections()" required>
                        <option value="jpl-hall" disabled selected hidden>LPU ESports Arena</option> <!-- Faded default option -->
                        <option value="jpl-hall" data-price="150">LPU ESports Arena</option>
                    </select>
                </div>
