...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="left">
                <img src="images/ldtm.png" alt="Arena Seat Plan">
            </div>
 
        <div class="right">
            <h2>LDT Goes OPM: A Dance Concert</h2>
            <h3>May 24, 2025 | JPL HALL OF FREEDOM</h3>
            <br>
            ...
            <div class="form-group">
                    ...
                    <select id="event_name" name="event_name" required>
                        <option>LPU Dance Troupe Concert</option>
                    </select>
                </div>
