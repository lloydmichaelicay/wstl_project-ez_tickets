...
<body> 
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="left">
                <img src="images/batingaw.jpg" alt="Arena Seat Plan">
            </div>

        <div class="right">
            <h2>48th Tanghalang Batingaw Year Ender</h2>
            <h3>June 20-21, 2025 | 3rd Floor, JPL Hall of Freedom</h3>
            <br>
            <form action="db_seating.php" method="POST">  
                <div class="form-group">
                    <label for="name">Date</label>
                    <select id="event_name" name="event_name" required>
                        <option value="" disabled selected hidden>Select options</option> <!-- Faded default option -->
                        <option>Tanghalang Batingaw Show Day 1</option>
                        <option>Tanghalang Batingaw Show Day 2</option>
                    </select>
                </div>
                ...
                <label for="location">Venue</label> 
                    <select id="location" name="seat_section" onchange="filterSections()" required>
                        <option value="" disabled selected hidden>JPL Hall of Freedom</option> <!-- Faded default option -->
