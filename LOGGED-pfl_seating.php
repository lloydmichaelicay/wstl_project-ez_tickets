...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="left">
                <img src="images/rizal_seating.png" alt="Arena Seat Plan">
            </div>

        <div class="right">
            <h2>Philippines Football League 2024-2025</h2>
            <h3>December 14, 2024 | RIZAL FOOTBALL STADIUM</h3>
            <br>
            <div class="form-group">
                ...
                <select id="location" onchange="filterSections()" required>
                    ...
                    <option value="bleachers" data-price="150">Bleachers</option>
                    <option value="lower-grandstand" data-price="150">Lower Grandstand</option>
                    <option value="upper-grandstand" data-price="150">Upper Grandstand</option>
                </select>
            </div>
            <div class="form-group">
