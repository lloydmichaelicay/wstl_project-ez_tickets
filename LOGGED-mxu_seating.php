...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="left">
                <img src="images/mxu.jpg" alt="Arena Seat Plan">
            </div>
 
        <div class="right">
            <h2>MxU CITHM 2025 Alab Coronation Day</h2>
            <h3>May 16, 2025 | JPL HALL OF FREEDOM</h3>
            <br>
            ...
            <div class="form-group">
                    ...
                    <select id="event_name" name="event_name" required>
                        <option>MxU Alab Coronation Day</option>
                    </select>
                </div>
