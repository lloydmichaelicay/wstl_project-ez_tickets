...
<head>
    ...
    <title>PH Sport Arena Seating</title>
...
<body>
    ...
    <main>
        ...
        <div class="right">
            <h2>PVL 2024-2025 All Filipino Conference</h2>
            <h3>November 29, 2024 | PhilSports Arena</h3>
            <br> 
            <div class="form-group">
                ...
                <select id="location" onchange="filterSections()" required>
                    ...
                    <option value="psa-courtside" data-price="650">Courtside</option>
                    <option value="psa-patron" data-price="550">Patron</option>
                    <option value="psa-lower-box" data-price="400">Lower Box</option>
                    <option value="psa-upper-box" data-price="125">Upper Box</option>
                </select>
            </div>
